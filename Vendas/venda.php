    ...
    <div class="container-all">
        ...
        <div class="corpo-formulario">
                ...
                <div class="linha1-formulario">
                    ...
                    <input type="text" name= "codigo" placeholder="Código do Cliente"><br><br>
                    <label for="name">Cliente</label> &nbsp;
                    <input type="text" name= "name" placeholder="Nome do Cliente" readonly ><br><br>
                ...
                <div class="linha2-formulario">
                    ...
                    <input name="codigop" id="codigop" size ="15" placeholder="Código do Produto"> &nbsp; &nbsp; &nbsp; &nbsp
                    <label for="pdt">Produto</label> &nbsp; 
                    <input name="produto" id="pdt" placeholder="Nome do Produto"readonly > &nbsp; &nbsp; &nbsp; &nbsp
                    <label for="preco">Preço Unitário</label> &nbsp; 
                    <input name="preco" id="preco" size ="15" placeholder="Preço unitário" readonly > &nbsp; &nbsp; &nbsp; &nbsp
                    <label for="quantidade">Estoque</label> &nbsp; 
                    <input name="quantidade" id="quantidade" size ="15" placeholder="Estoque" readonly > &nbsp; &nbsp; &nbsp; &nbsp
                </div>

                <div class="linha3-formulario">
                    <label for="qtdvenda">Quantidade</label> &nbsp; 
                    <input type="number" name= "qtdvenda" id ="qtdvenda" placeholder="Quantidade vendida" min= "1" size ="15"><br>
                    <label for="desconto">Desconto</label> &nbsp; 
                    <input name= "desconto" id ="desconto" placeholder="00,00"  onblur="calcula()" size ="15"><br>
                    <label for="totalvenda">Valor Total da Venda</label> &nbsp; 
                    <input name= "totalvenda" id = "totalvenda" readonly size ="15" ><br>
                </div>

                <div class="linha4-formulario">
                    <label for="info">Informações adicionais</label>
                    <textarea name="info" id="info" placeholder="Detalhamento adicional"></textarea>
                </div>
    ...
    if (isset($_POST['codigo'])){
        ...
        { 
            ...
            if($user->msgErro == "")
            {
                ...
                {
                $user ->cadastrarV($codigo,$name, $data,$codigop,$produto,$preco,
